function LHCF_GetLocalizationTable(lang)
	...
	if lang =="huHU" then
		...
		LHCFLocalization["wilhelm"] = "Ha ez a gomb ki van pipálva, akkor időnként amikor a karakterünk meghal, a Wilhelm Scream hangeffekttel távozik az élők sorából."
	...
	if lang =="enUS" then
		...
		LHCFLocalization["wilhelm"] = "If this button is checked, then sometimes when your character dies, it leaves the world of the living with a Wilhelm Scream sound effect."
